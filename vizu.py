...
predict = []
with open('./results/OP04-R04-ContinentalBreakfast.txt', 'r') as f:
    for line in f:
        predict.append(int(line.split('\n')[0]))

true_label = []
with open( "./hw4_data/FullLengthVideos/labels/valid/OP04-R04-ContinentalBreakfast.txt", 'r') as f:
    for line in f:
        true_label.append(int(line.split('\n')[0]))

img_dir = "./hw4_data/FullLengthVideos/videos/valid/OP04-R04-ContinentalBreakfast"
